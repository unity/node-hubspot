...
function Client(opts) {
  ...
  var contacts = {
    ...
    createOrUpdate: function (data, email, cb) {
      sendRequest({
        method: 'POST',
  ...
  var contactProperties = {
    ...
    update: function (data, propertyName, cb){
      sendRequest({
        method: 'PUT',
        url: self.baseUrl + 'contacts/v2/groups/named/'+ groupName,
        body: data
      }, { auth: true }, cb);
    }
  };

  var contactPropertiesGroups = {
    get: function (options, cb) {
      if (typeof options === 'function') {
        cb = options;
        options = {};
      ...
      sendRequest({
        method: 'GET',
        url: self.baseUrl + 'contacts/v2/groups/',
        qs: options
      }, { auth: true }, cb);
    },
    create: function (data, cb){
    ...
    update: function (data, groupName, cb){
      sendRequest({
        method: 'PUT',
        url: self.baseUrl + 'contacts/v2/groups/named/'+ groupName,
        body: data
  ...
  return {
    ...
    contacts: contacts,
    contactPropertiesGroups: contactPropertiesGroups,
