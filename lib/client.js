...
function Client(opts) {
  ...
  var properties = {
    ...
    getOne: function(property_name, cb) {
      if (!property_name || typeof property_name === "function") {
        return cb(new Error("property_name parameter must be provided."));
      }

      var call = {
        method: 'GET',
        url: self.baseUrl + 'contacts/v2/properties/named/' + property_name
      };
